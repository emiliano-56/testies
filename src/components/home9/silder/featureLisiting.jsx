  ...
  return (
    <>
      <div>
        <OwlCarousel
          {...settings}
          className="real-featured-listing owl-carousel owl-theme"
        >
          <div className="feature-rent">
            <div className="feature-home-img">
              <Link to="/listingmap-list">
                <img src={property_feature_1} className="img-fluid" alt="" />
              </Link>
            </div>
            <div className="green-logo">
              <img src={feature_text_logo} className="img-fluid" alt="" />
            </div>
            <div className="select-favourite-room">
              <div className="favourite-small-user">
                <img src={ProfileAvatar01} className="img-fluid" alt="" />
              </div>
            ...
            <div className="home-img-text">
              ...
              <div className="top-room-details">
                <div className="area">
                  <span>
                    <img src={area_icon} className="img-fluid" alt="" />
                    Area:56000/m2
                  </span>
                </div>
                <div className="area">
                  <span>
                    <img src={bed_icon} className="img-fluid" alt="" />
                    Beds:3
                  </span>
                </div>
                <div className="area">
                  <span>
                    <img src={bath_icon} className="img-fluid" alt="" />
                    Baths:2
                  </span>
                </div>
              </div>
          ...
          <div className="feature-rent">
            <div className="feature-home-img">
              <Link to="/listingmap-list">
                <img src={property_feature_2} className="img-fluid" alt="" />
              </Link>
            </div>
            <div className="green-logo">
              <img src={feature_text_logo} className="img-fluid" alt="" />
          ...
          <div className="feature-rent">
            <div className="feature-home-img">
              <Link to="/listingmap-list">
                <img src={property_feature_3} className="img-fluid" alt="" />
              </Link>
            </div>
            <div className="green-logo">
              <img src={feature_text_logo} className="img-fluid" alt="" />
