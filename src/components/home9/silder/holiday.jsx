...
import {
  ...
  floor_icon,
  guest_icon,
  holiday_cabin_slider,
  holiday_cabin_slider_2,
} from "../../imagepath";
  ...
  return (
    <>
      <div>
        <OwlCarousel
          {...settings}
          className="holiday-cabin-img-slider owl-carousel"
        >
          <div className="item">
            <img src={holiday_cabin_slider} className="img-fluid" alt="" />
          ...
          <div className="item">
            <img src={holiday_cabin_slider_2} className="img-fluid" alt="" />
            <div className="container">
