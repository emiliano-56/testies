  ...
  return (
    <>
      <div data-aos="fade-right">
        <OwlCarousel
          {...settings}
          className="top-listings-rent-slider owl-carousel"
        >
          <div className="top-rent-room">
            <div className="top-room-img">
              <Link to="/categories">
                <img src={top_rent_room_img_1} className="img-fluid" alt="" />
              </Link>
            </div>
            ...
            <div className="top-rent-room-info">
              ...
              <div className="top-room-details">
                ...
                <div className="area">
                  <span>
                    <img src={floor_icon} className="img-fluid" alt="" />
                    Floors:4
                  </span>
                </div>
                <div className="area">
                  <span>
                    <img src={guest_icon} className="img-fluid" alt="" />
                    Guest:4
                  </span>
                </div>
              </div>
          ...
          <div className="top-rent-room">
            <div className="top-room-img">
              <Link to="/categories">
                <img src={top_rent_room_img_2} className="img-fluid" alt="" />
              </Link>
            </div>
            <div className="top-listing-rounded-img">
              <div className="favourite-small-user">
          ...
          <div className="top-rent-room">
            ...
            <div className="top-listing-rounded-img">
              <div className="favourite-small-user">
                <img src={ProfileAvatar06} className="img-fluid" alt="" />
              </div>
            </div>
            <div className="pent-house">
              <span>Pent house</span>
