    ...
    <div>
      <OwlCarousel {...settings} className="test-slider owl-carousel owl-theme">
        <div className="testi-widget-seven aos" data-aos="fade-up">
          <div className="test-details">
            <div className="icon-blk">
              <img src={ProfileAvatar01} alt="Dreamstrip Testimonials" />
            </div>
        ...
        <div className="testi-widget-seven aos" data-aos="fade-up">
          <div className="test-details">
            <div className="icon-blk">
              <img src={ProfileAvatar02} alt="Dreamstrip Testimonials" />
            </div>
            <div className="people-name">
              <h5>John Doe</h5>
              <div className="review">
        ...
        <div className="testi-widget-seven aos" data-aos="fade-up">
          <div className="test-details">
            <div className="icon-blk">
              <img src={ProfileAvatar03} alt="Dreamstrip Testimonials" />
            </div>
            <div className="people-name">
              <h5>William</h5>
              <div className="review">
        ...
        <div className="testi-widget-seven aos" data-aos="fade-up">
          <div className="test-details">
            <div className="icon-blk">
              <img src={ProfileAvatar04} alt="Dreamstrip Testimonials" />
            </div>
            <div className="people-name">
              <h5>Lisa</h5>
              <div className="review">
